...
class LocationService: NSObject, CLLocationManagerDelegate{
    ...
    func startAutoTrackingLocation() {
                ...
                if let lastPlacemark = placemarks?.last {
                    do {
                        ...
                        if self!.startingAddress == "" {
                            ...
                            self?.delegate?.locationService(self!, didUpdate: "\(latitude) \(longitude)", using: self!.currentAddress!.addressString(), didUpdate: self!.speed, didUpdate: totalDistance)
                            print("Speed from initial call = \(self!.speed)")
                        }
    ...
    @objc func refreshSpeed() {
        delegate?.locationService(self, speedUpdate: speed)
        //print("Current Speed Testing = \(speed)")
    }
